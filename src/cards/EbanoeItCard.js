...
const PATH_BASE = 'https://ebanoe.it/feed/';

export class EbanoeItCard extends React.Component {
    ...
    render() {
        ...
        const title = <h4 style={{margin: 0}}><a href="https://ebanoe.it/">Ebanoe.IT</a></h4>;
        if (error) {
            return (
